export const temazcal = {
  image: "bg-temazcal-image",
  title: "TEMAZCAL",
  subtitle: "¿QUÍEN CODUCE EL TEMAZCAL?",
  description:
    "Lídia Hidalgo, con más de 15 años al servicio, portadora de la chanupa y autorizada por la  abuela Margarita. Maestra chamana.",
  ...
  event: {
    date: "22  DICIEMBRE - 16:00H",
    title: "TEMAZCAL DEL SOLSTICIO DE INVIERNO",
    description:
      "Recibiendo el invierno y templando nuestro fuego interno. *En esta ocasión solo se celebrará el temazcal, si quieres pasar la noche, contáctanos.",
  },
  benefitsCards: [
